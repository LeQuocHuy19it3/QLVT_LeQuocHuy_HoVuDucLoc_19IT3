...
public class KhachHangModel implements Serializable {
    ...
    public KhachHangModel(int id, String hoTen, byte gioiTinh, String sdt, int maPhieuint) {
        this.id = id;
        this.hoTen = hoTen;
    ...
    public KhachHangModel(int id, String hoTen, byte gioiTinh, String sdt, PhieuDatVeModel maPhieu) {
        this.id = id;
        this.hoTen = hoTen;
        this.gioiTinh = gioiTinh;
        this.sdt = sdt;
